<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        ?>
        <span class="logo-lg"><b>Perpustakaan Digital</b> <i class="fa fa-book"></i></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="#Logout" data-toggle="modal" data-target="#modalLogoutConfirm" class="btn btn-default btn-flat bg-red">Keluar</a>
                        </li>
                    </ul>
                </li>
            </ul>
